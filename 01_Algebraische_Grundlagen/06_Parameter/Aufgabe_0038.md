...
tags: Tabelle, Parameter, Äquivalenzumformung, Negative Zahlen, schwer, normal, Angeben
...
data-type="none" 
data-sortable="false" -->
|  $d$  |  $v$  |  $c$  | $d$ [[($+$)|$-$|$\cdot$|$:$]] $v\cdot$ [[ c ]] | $(d$ [[$+$|($-$)|$\cdot$|$:$]] [[ 3 ]] $\cdot c):v$ | $d:$ [[ c ]] [[$+$|($-$)|$\cdot$|$:$]] $v$ |
| :---: | :---: | :---: | :-------: | :----------------: | :--------: |
| $-24$ | $3$ | $-4$ | [[ -36 ]] @canvas | [[ -4 ]] @canvas | [[ 3 ]] @canvas |
| [[ -16 ]] @canvas | $-2$ | $4$ | $-24$ | [[ 14 ]] @canvas | [[ -2 ]] @canvas |
| $30$ | [[ -5 ]] @canvas | $-5$ | [[ 55 ]] @canvas | [[ -9 ]] @canvas | $-1$ |
| $-36$ | $6$ | [[ -6 ]] @canvas | [[ -72 ]] @canvas | $-3$ | [[ 0 ]] @canvas |
@Algebrite.check([ c; 3; c; -36; -4; 3; -16; 14; -2; -5; 55; -9; -6; -72; 0 ])
