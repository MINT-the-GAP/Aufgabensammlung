...
tags: Tabelle, Parameter, Äquivalenzumformung, Dezimalzahlen, leicht, normal, Angeben
...
data-type="none" 
data-sortable="false" -->
|  $q$  |  $l$  |  $s$  | $q+l\cdot s$ | $(q+s):l$ | $q:s+l$ |
| :---: | :---: | :---: | :-----------: | :-------: | :-----: |
| $1{,}5$ | $0{,}6$ | $0{,}3$ | [[ 1,68 ]] @canvas | [[ 3,0 ]] @canvas | [[ 5,6 ]] @canvas |
| [[ 2,0 ]] @canvas | $0{,}4$ | $0{,}5$ | $2{,}2$ | [[ 6,25 ]] @canvas | [[ 4,4 ]] @canvas |
| $2{,}4$ | [[ 0,8 ]] @canvas | $0{,}6$ | [[ 2,88 ]] @canvas | [[ 3,75 ]] @canvas | $4{,}8$ |
| $3{,}6$ | $1{,}2$ | [[ 1,2 ]] @canvas | [[ 5,04 ]] @canvas | $4{,}0$ | [[ 4,2 ]] @canvas |
@Algebrite.check([ 1.68; 3.0; 5.6; 2.0; 6.25; 4.4; 0.8; 2.88; 3.75; 1.2; 5.04; 4.2 ])
