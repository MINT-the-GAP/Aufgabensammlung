...
$= -($ [[  1,8  ]] @canvas $):20 - 0,4 \cdot 0,125 $ \
$= $ [[ -1,8  ]] @canvas $:20 - 0,4 \cdot 0,125 $ \
$= $ [[ -0,09 ]] @canvas $ - 0,4 \cdot 0,125 $ \
$= $ [[ -0,09 ]] @canvas $ - $ [[  0,05  ]] @canvas  \
$=$ [[ -0,14 ]] @canvas 
...
$=$ [[  0,13  ]] @canvas $ - 0,4 \cdot 1,7 - 0,7 : 0,2 $ \
$=$ [[  0,13  ]] @canvas $ - $ [[  0,68  ]] @canvas $ - 0,7 : 0,2 $ \
$=$ [[ -0,55  ]] @canvas $ - 0,7 : 0,2 $ \
$=$ [[ -0,55  ]] @canvas $ - $ [[  3,5  ]] @canvas  \
$=$ [[ -4,05  ]] @canvas 
...
$=$ [[ -1,275 ]] @canvas $ + (-0,85 : 1,7) \cdot (-3,5)   $ \
$=$ [[ -1,275 ]] @canvas $ + $ ([[  -0,5  ]] @canvas) $ \cdot (-3,5)   \
$=$ [[ -1,275 ]] @canvas $ + $ [[  1,75  ]] @canvas $  \
$=$ [[  0,475 ]] @canvas 
...
$= ($ [[  -7,6   ]] @canvas $ - 4,2 \cdot 0,25) \cdot (-1,5) $ \
$= ($ [[  -7,6   ]] @canvas $ - $ [[  1,05   ]] @canvas $) \cdot (-1,5) $ \
$= $ [[ -8,65   ]] @canvas $ \cdot (-1,5) $ \
$=$ [[  12,975 ]] @canvas 
