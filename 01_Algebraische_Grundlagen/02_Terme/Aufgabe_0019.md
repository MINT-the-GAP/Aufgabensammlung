...
$=$ [[ 2/5 ]] @canvas $ - \dfrac{1}{5}$ \
$=$ [[ 1/5 ]] @canvas
@Algebrite.check([ 13/10; 2/5; 1/5 ])
...
$=$ [[ 1/6 ]] @canvas $ + \dfrac{1}{3}$ \
$=$ [[ 1/2 ]] @canvas
@Algebrite.check([ 3/4; 1/3; 1/6; 1/2 ])
...
$=$ [[ 3/4 ]] @canvas $ +$ [[ 1/2 ]] @canvas \
$=$ [[ 5/4 ]] @canvas
@Algebrite.check([ 5/8; 5/6; 3/4; 1/2; 5/4 ])
