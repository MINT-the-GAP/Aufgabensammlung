...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-3.85:1.75] (\x, {1*pow((\x+1),2)-4 } ) node[above] {\Large $f$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-4:-1.33] (\x, {1*pow((\x+3),2)+1 } ) node[above] {\Large $g$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=2.33:4] (\x, {-1*pow((\x-4),2)-1 } ) node[right] {\Large $h$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-4:-0.2] (\x, {-1*pow((\x+3),2)+4 } ) node[below] {\Large $k$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-1.45:3.45] (\x, {1*pow((\x-1),2)-2 } ) node[above] {\Large $l$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=.33:4] (\x, {-1*pow((\x-3),2)+3 } ) node[right] {\Large $m$};  
  \end{scope}
