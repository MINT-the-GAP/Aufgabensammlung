...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-0.55:2.6] (\x, {3*pow((\x-1),2)-3.5 } ) node[above] {\Large $f$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-4:-1.3] (\x, {-2*pow((\x+3),2)+2 }  ) node[below] {\Large $g$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-0.9:2.9] (\x, {2*pow((\x-1),2)-3.5  } ) node[right] {\Large $h$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-4:-1.6] (\x, {-3*pow((\x+3),2)+2} ) node[right] {\Large $k$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-4:-0.4] (\x, {1.5*pow((\x+2.5),2)-3 } ) node[right] {\Large $l$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=0.4:4] (\x, {1.5*pow((\x-2.5),2)-3 } ) node[right] {\Large $m$};  
  \end{scope}
