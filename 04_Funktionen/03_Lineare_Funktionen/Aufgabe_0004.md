...
@CoordinateSystem(`xmin=-1;xmax=7;ymin=-1;ymax=4;width=600;id=LF0004;1;1;1`)
@AxisLabel(`id=LF0004;xlabel=$x$;ylabel=$y$`)

@PlotFunction(`LF0004;f;x;#00ff00`)
@PlotFunction(`LF0004;g;0.25*x+1;#ff0000`)
@PlotFunction(`LF0004;h;0.5*x;#0000ff`)
