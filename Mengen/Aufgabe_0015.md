...
data-hint-button="3"  -->
$\mathbb{K} \cup \mathbb{M} =  $ [[   {1,3,4,5,6,8,9}   ]] @canvas $  $ 
[[?]] @Explain


@resetter

@ADetails(1=BE; Mengen, Vereinigung)
...
data-solution-button="5" 
data-hint-button="3"  -->
$\mathbb{K} \cup \mathbb{M} =  $ [[   {1,2,3,4,5,6,7}   ]] @canvas $  $ 
[[?]] @Explain
...
data-solution-button="5" 
data-hint-button="3"  -->
$\mathbb{K} \cup \mathbb{M} =  $ [[   {4,5,7,8,9,10,11}   ]] @canvas $  $ 
[[?]] @Explain
