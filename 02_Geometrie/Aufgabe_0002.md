...
@Koordinatensystem(`xmin=-1;xmax=10;ymin=-1;ymax=5;width=700;id=K0002`)

@AchsenBeschriftung(`id=K0002;xlabel=$x$;ylabel=$y$`)


@Punkt(`K0002;A;9;1;fix`)
@Punkt(`K0002;B;4;4;fix`)
@Punkt(`K0002;C;6;0;fix`)
