...
@Koordinatensystem(`xmin=-1;xmax=10;ymin=-1;ymax=5;width=700;id=K0004`)

@AchsenBeschriftung(`id=K0004;xlabel=$x$;ylabel=$y$`)


@Punkt(`K0004;A;7;1;fix`)
@Punkt(`K0004;B;1;4;fix`)
@Punkt(`K0004;C;3;3;fix`)
