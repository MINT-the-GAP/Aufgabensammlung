...
[[Antwort]]
[[?]] @Explain
```text @LLMQuiz(0.55;coverage=0.55;solution=1;feedback=1;assessmentengine=quality;Rechtschreibung=1;Satzbau=1,`Gegeben sei ein Dreieck $ABC$ mit den Seitenlängen $a=5\,\mathrm{cm}$, $b=4\,\mathrm{cm}$ und $c=6\,\mathrm{cm}$. Beschreibe schrittweise, wie das Dreieck mit dem Kongruenzsatz SSS mit Zirkel und Lineal konstruiert wird.`)
<!-- lia-llm:criterion -->
