...
\draw[-, black!100, thin]  (0.1,10) -- (-0.1,10) node[left] {\Large 10};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
  ...
  \coordinate[label=center:\LARGE$\times$] (a) at (0+0.055,3-0.055);
  \node[below right] at (a) {\LARGE $A$};

  %\coordinate[label=center:\LARGE$\times$] (b) at (8+0.055,3-0.055);
  %\node[below right] at (b) {\LARGE $B$};

  \coordinate[label=center:\LARGE$\times$] (c) at (8+0.055,5-0.055);
  \node[below right] at (c) {\LARGE $C$};

  \coordinate[label=center:\LARGE$\times$] (d) at (0+0.055,5-0.055);
...
\draw[-, black!100, thin]  (0.1,10) -- (-0.1,10) node[left] {\Large 10};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
  ...
  \coordinate[label=center:\LARGE$\times$] (a) at (1+0.055,1-0.055);
  \node[below right] at (a) {\LARGE $A$};

  %\coordinate[label=center:\LARGE$\times$] (b) at (4+0.055,1-0.055);
  %\node[below right] at (b) {\LARGE $B$};

  \coordinate[label=center:\LARGE$\times$] (c) at (7+0.055,7-0.055);
  \node[below right] at (c) {\LARGE $C$};

  \coordinate[label=center:\LARGE$\times$] (d) at (1+0.055,4-0.055);
  \node[below right] at (d) {\LARGE $D$}; 
