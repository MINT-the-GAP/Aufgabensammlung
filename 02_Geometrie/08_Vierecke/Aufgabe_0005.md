...
\draw[-, black!100, thin]  (0.1,10) -- (-0.1,10) node[left] {\Large 10};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
  ...
  \coordinate[label=center:\LARGE$\times$] (a) at (3+0.055,4-0.055);
  \node[below right] at (a) {\LARGE $A$};

  %\coordinate[label=center:\LARGE$\times$] (b) at (4+0.055,0-0.055);
  %\node[below right] at (b) {\LARGE $B$};

  \coordinate[label=center:\LARGE$\times$] (c) at (10+0.055,4-0.055);
  \node[below right] at (c) {\LARGE $C$};

  \coordinate[label=center:\LARGE$\times$] (d) at (4+0.055,8-0.055);
...
\draw[-, black!100, thin]  (0.1,10) -- (-0.1,10) node[left] {\Large 10};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
  ...
  \coordinate[label=center:\LARGE$\times$] (a) at (2+0.055,2-0.055);
  \node[below right] at (a) {\LARGE $A$};

  \coordinate[label=center:\LARGE$\times$] (b) at (6+0.055,3-0.055);
  \node[below right] at (b) {\LARGE $B$};

  \coordinate[label=center:\LARGE$\times$] (c) at (5+0.055,7-0.055);
  \node[below right] at (c) {\LARGE $C$};

  %\coordinate[label=center:\LARGE$\times$] (d) at (1+0.055,6-0.055);
  %\node[below right] at (d) {\LARGE $D$}; 
