...
@CoordinateSystem(`xmin=-0.5;xmax=10.5;ymin=-0.5;ymax=10.5;width=500;id=VQ0005a;1;1;0`)
@AxisLabel(`id=VQ0005a;xlabel=$x$;ylabel=$y$`)

@Punkt(`VQ0005a;A;3;4;#ff00ff;1;fix`)
@Punkt(`VQ0005a;C;10;4;#ff00ff;1;fix`)
@Punkt(`VQ0005a;D;4;8;#ff00ff;1;fix`)
...
@CoordinateSystem(`xmin=-0.5;xmax=10.5;ymin=-0.5;ymax=10.5;width=500;id=VQ0005b;1;1;0`)
@AxisLabel(`id=VQ0005b;xlabel=$x$;ylabel=$y$`)

@Punkt(`VQ0005b;A;2;2;#ff00ff;1;fix`)
@Punkt(`VQ0005b;B;6;3;#ff00ff;1;fix`)
@Punkt(`VQ0005b;C;5;7;#ff00ff;1;fix`)
