...
\draw[-, black!100, thin]  (0.1,6) -- (-0.1,6) node[left] {\Large 6};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
  ...
  \coordinate[label=center:\LARGE$\times$] (a) at (1+0.03,5-0.02);
  \node[below right] at (1,5) {\LARGE $A$};

  \coordinate[label=center:\LARGE$\times$] (b) at (10+0.03,4-0.02);
  \node[below right] at (10,4) {\LARGE $B$};

  \coordinate[label=center:\LARGE$\times$] (c) at (3+0.03,2-0.02);
  \node[below right] at (3,2) {\LARGE $C$};

  \coordinate[label=center:\LARGE$\times$] (d) at (5+0.03,4-0.02);
  \node[below right] at (5,4) {\LARGE $D$};

  \coordinate[label=center:\LARGE$\times$] (e) at (1+0.03,0-0.02);
  \node[below right] at (7,1) {\LARGE $E$};
