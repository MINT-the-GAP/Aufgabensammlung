...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-2.4:4] (\x, {-0.5*pow(\x-1.5,2)+3.5 } ) node[right] {\Large $f$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-1.85:2.7] (\x, { -2*(\x*\x*\x*\x/4-\x*\x*\x*2/3-\x*\x/2+\x*2) } ) node[right] {\Large $g$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-1.85:2.7] (\x, { 2*(\x*\x*\x*\x/4-\x*\x*\x*2/3-\x*\x/2+\x*2) } ) node[above] {\Large $h$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-4:3.15] (\x, {0.25*pow(\x+2,2)-2.5 } ) node[right] {\Large $k$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-3.33:1.33] (\x, {-1.25*(\x-1)*(\x+1)*(\x+3) } ) node[below] {\Large $l$};  
  \end{scope}
...
\draw[-, black!100, thin]  (0.1,-4) -- (-0.1,-4) node[left] {\large -4};
 ...
 \draw [ black!100, thick]  (ya) --(o) --  (xa);
	...
	\draw[thick,color=red, ]  plot[samples=100, domain=-1.25:2.4] (\x, { -2*(\x*\x*\x-\x*\x*2-\x+2) } ) node[below] {\Large $m$};  
  \end{scope}
