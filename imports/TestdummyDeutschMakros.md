...
@orthography(`<!-- data-solution-timer="6s" data-solution-timer-start="oncheck" data-solution-timer-badge="off" -->`,`Es ist jetze um sechse.`,`Es ist jetzt um sechs.`)
...
@orthography(`<!--  data-solution-button="4"  -->`,`Das ist der Tag an dem ich geblitzt wurde.`,`Das ist der Tag, an dem ich geblitzt wurde.`)
...
@orthography(`<!--    -->`,`Der Apfel ist rot sagte Ben`,`"Der Apfel ist rot", sagte Ben.`)



__$b)\;\;$__

@orthography(`<!--    -->`,`Clara sagt Druck ist eine physikalische Größe`,`Clara sagt: "Druck ist eine physikalische Größe."`)
